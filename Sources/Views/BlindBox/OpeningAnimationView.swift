...
#Preview {
    OpeningAnimationView(instance: DataStore.shared.data.instances.first ?? TaskInstance(templateId: UUID(), characterId: UUID(), categoryId: UUID(), title: "测试任务", description: "", rewardPoints: 10, timeoutPenalty: 3, skipCost: 30, timeLimitMinutes: 60, difficulty: .normal, rarity: .n),
                        slot: 5, onClose: {})
